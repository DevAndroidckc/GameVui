...
public class PlayGame extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
        ...
        btnCallActivityMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mYes.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(PlayGame.this, Menu.class);
      ...
      final TextView DemNguoc= findViewById(R.id.textView_dem_nguoc);
       countDownTimer =new CountDownTimer(30000,1000) {
          ...
          public void onFinish() {
              Toast.makeText(PlayGame.this,"Hết thời gian",Toast.LENGTH_SHORT).show();
          }
